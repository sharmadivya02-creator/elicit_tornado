...
const RippleDistortion: React.FC<RippleDistortionProps> = ({
  ...
  useEffect(() => {
    ...
    image.onload = () => {
      ...
      (compositeUniforms.uTextureSize as any).value = [image.naturalWidth || 1, image.naturalHeight || 1];
    };
    image.src = src;
    ...
    const resize = () => {
      ...
      (compositeUniforms.uResolution as any).value = [width, height];
      ...
      (compositeUniforms.uTexel as any).value = [1 / fieldW, 1 / fieldH];
    };
